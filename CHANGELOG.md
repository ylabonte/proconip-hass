...
* add fault-state sensor, problem binary_sensor, and severity-threshold select ([#75](https://github.com/ylabonte/proconip-hass/issues/75)) ([24a38d2](https://github.com/ylabonte/proconip-hass/commit/24a38d2c472d184d4397b4a9ee3788bcb121ba3e))
