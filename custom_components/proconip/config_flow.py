...
class ProconipFlowHandler(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    def async_get_options_flow(config_entry):
        return ProconipOptionsFlowHandler(config_entry)
...
class ProconipOptionsFlowHandler(config_entries.OptionsFlow):
    """Config flow options handler for proconip."""
